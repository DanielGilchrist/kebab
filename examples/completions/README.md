...
The shell is a typed argument (`getter shell : Kebab::Completion::Shell`). Enums parse automatically, so an unknown shell fails at parse time with `one of: bash, fish or zsh`.
